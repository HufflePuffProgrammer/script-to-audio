      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm space-y-2">
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-gray-600">
                  POST `/api/admin/character-builder` 
                </p>
              </div>
              <span className="rounded-full bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-700">
                API
          ...
          <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm space-y-2">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-sm font-semibold text-gray-800">Parse Screenplay Build Dialogue Boxes</p>
                <p className="text-xs text-gray-600">
                  Post `/api/admin/parse-screenplay`
                </p>
              </div>
              <span className="rounded-full bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-700">
                Link
          ...
          <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm space-y-2">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-sm font-semibold text-gray-800">Build Dialogue Box</p>
                <p className="text-xs text-gray-600">
                  POST `/api/admin/build-dialogue-box` scene id, characters, voice id, dialogue boxes
                </p>
              </div>
              <span className="rounded-full bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-700">
                API
          ...
          <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm space-y-2">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-sm font-semibold text-gray-800">Build Audio </p>
                <p className="text-xs text-gray-600">
                  Build audio per dialogue box
                </p>
              </div>
              <span className="rounded-full bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-700">
                Link
            ...
            <div className="flex gap-3">
              <Link
                href="/admin/build-audio-per-dialogue-box-scene"

                className="inline-flex items-center gap-2 rounded-md border border-gray-200 px-3 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50"
              >
                Go to build Audio Per Dialogue Box Scene
              </Link>
            </div>
          </section>
          <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm space-y-2">
            ...
            <div className="flex gap-3">
             <Link 
             href="/admin/build-complete-audio" 
             className="inline-flex items-center gap-2 rounded-md border border-gray-200 px-3 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50"
            >
            Go to Build Complete Audio
             </Link>
            </div>
          </section>
          <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm space-y-2">
          ...
          <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm space-y-2">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-sm font-semibold text-gray-800">Screenplay stats</p>
                <p className="text-xs text-gray-600">
                  Lists screenplays with scene/character counts and pipeline stage.
                </p>
              </div>
              <span className="rounded-full bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-700">
                Link
