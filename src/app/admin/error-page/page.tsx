        ...
        <header className="flex flex-wrap items-start justify-between gap-4">
          <div className="space-y-2">
            ...
            <p className="max-w-2xl text-sm text-slate-600">
              Recent rows from the <code>errors</code> table (written by{" "}
              <code>logDbError</code> when Supabase operations fail).
            </p>
            <p className="text-sm text-slate-600">
              <a href="http://localhost:3000/api/admin/errors/test" target="_blank" rel="noopener noreferrer">
                Test endpoint
              </a>
            </p>
          </div>
