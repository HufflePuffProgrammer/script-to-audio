...
export async function POST (request: Request){
    ...
    try{
         ...
         if (dialogue_boxes_scenes == null){
            console.error("No dialogue boxes scenes provided.");
         ...
         if (!audio_url || error){
            console.error("Failed to build complete audio.",error ?? "Unknown error");
         ...
         console.error("3Failed to build: API build-complete-audio error:", error);
